    ...
    <div className="bg-gray-100 min-h-screen flex justify-center items-center ">
      ...
      <div className="bg-white shadow-lg rounded-lg p-8">
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          <div>
            <label htmlFor="currentWeight" className="block mb-2 text-sm font-medium text-gray-700">
              Current Weight
            </label>
            <input
              type="text"
          ...
          <div>
            <label htmlFor="emergencyContactPerson" className="block mb-2 text-sm font-medium text-gray-700">
          ...
          <div>
            <label htmlFor="deserveReason" className="block mb-2 text-sm font-medium text-gray-700">
