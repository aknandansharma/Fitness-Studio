...
function Yoga() {
	return (
		...
		{/* yoga main start */}
		  ...
		  <span className=" text-6xl" ><span style={{color:"#3B8004"}}>Yoga</span> to Release <span style={{color:"#DAA520"}}>Stress.</span> </span>
        </div>
        ...
        {<img className='heroimg'
          src={Img}
          alt='herobanner'
          style={{ width:"20vw", position:'absolute',right:'12%',bottom:"30%"}}
        /> }
              ...
              <div className="">
				...
				Get the best course at our Savasa Yoga.
                      ...
                      <div className="cardpara text-3xl font-bold ">
                          Attract fresh meditators by showcasing yoga's
        ...
        <div className='course '>
          <div className='coursecardone flex flex-row flex-wrap' >
              ...
              <div className="cardy one border border-1 border-white-500 p-2 drop-shadow-xl" style={{height:"550px"}}>
                <img
                  className="imgTransform rounded-xl border" style={{height:"300px",width:"90vh"}}
                  alt="green iguana"
                ...
                <div className="card-content">
                  ...
                  <p className="card-text p-3">
                    ...
                    It can be done while leaning back against a wall. Lorem ipsum dolor sit, amet consectetur 
                    adipisicing elit. Inventore in sunt impedit ducimus eaque commodi vero! Sapiente eaque
              ...
              <div className="cardy two border border-1 border-white-500 p-2 drop-shadow-xl" style={{height:"550px"}}>
                <img
                  className="imgTransform card-img rounded-xl" style={{height:"300px",width:"90vh"}}
                  alt="green iguana"
              ...
              <div className="cardy three border border-1 border-white-500 p-2 drop-shadow-xl" style={{height:"550px"}}>
                <img
                  className="imgTransform card-img rounded-xl" style={{height:"300px",width:"90vh"}}
                  alt="green iguana"
          ...
          <div className='coursecard flex flex-row flex-wrap'>
              ...
              <div className="cardy one border border-1 border-white-500 p-2 drop-shadow-xl" style={{height:"550px"}}>
                <img
                  className="imgTransform card-img border rounded-xl" style={{height:"300px",width:"90vh"}}
                  alt="green iguana"
